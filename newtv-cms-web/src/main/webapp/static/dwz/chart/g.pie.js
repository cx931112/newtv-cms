...
(function () {
    ...
    function Piechart(paper, cx, cy, r, values, opts,myData) {//myData自定义参数   格式:{param:data,...}
        opts = opts || {};
        myData = myData || {};
    ...
    //public
    Raphael.fn.piechart = function(cx, cy, r, values, opts,myData) {
        return new Piechart(this, cx, cy, r, values, opts,myData);
    }
