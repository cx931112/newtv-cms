	...
	<div class="pageContent">
		<form method="post" action="operationLog/operationLogList" method="post"
			...
			<div class="pageFormContent" layoutH="50">
				<div class="unit">
					<label>操作数据类型：</label>
					<select name="search_EQ_oprDataType" class="combox required" 
							remoteUrl="operationLog/getOperationDataTypeList">
					</select>
				</div>
				<div class="unit">
					<label>操作数据主键：</label>
					<input name="search_LIKE_oprDataId" type="text"
							value="${param.search_LIKE_oprDataId}" size="6"/>
				</div>
				<div class="unit">
					<label>操作类型：</label>
				...
				<div class="unit">
					<label>操作内容：</label>
					<input name="search_LIKE_logContent" type="text"
							value="${param.search_LIKE_logContent}" size="6"/>
				</div>
				<div class="unit">
					<label>日志记录时间：</label> <input type="text" size="25"
						...
						type="text" size="25" name="search_LTE_logTime_DATE" class="date" datefmt="yyyy-MM-dd HH:mm"  readonly="readonly"/>
				</div>
