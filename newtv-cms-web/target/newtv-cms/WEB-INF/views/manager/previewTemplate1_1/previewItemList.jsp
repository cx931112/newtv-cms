...
<script type="text/javascript">
	...
	function previewTemplate_addItem() {
		...
		//初始滑动事件
		initHoverEvent();
		return gridlyH(minheight,splitsize,columnCount/2,isDraggable,reordered);
	};
...
<script>
	...
	var items = $(".gridly div",navTab.getCurrentPanel());
	...
	itemInitPositionAndSize(items, minwidth, minheight, splitsize, function() {
		$('.gridly', navTab.getCurrentPanel()).gridlyH({
			base : minheight, // px 
			gutter : splitsize, // px
			columns : columnCount,
