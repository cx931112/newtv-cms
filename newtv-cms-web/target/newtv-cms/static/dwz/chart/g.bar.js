...
(function () {
	 ...
	 * Vertical Barchart
	 */
	function VBarchart(paper, x, y, width, height, values, opts,myData) {
		opts = opts || {};
		myData = myData || {};
	 ...
	 * Horizontal Barchart
	 */
	function HBarchart(paper, x, y, width, height, values, opts,myData) {
		opts = opts || {};
		myData = myData || {};
		var chartinst = this,
			type = opts.type || "square",
	...
	Raphael.fn.hbarchart = function(x, y, width, height, values, opts,myData) {
		return new HBarchart(this, x, y, width, height, values, opts,myData);
	};
	
	Raphael.fn.barchart = function(x, y, width, height, values, opts,myData) {
		return new VBarchart(this, x, y, width, height, values, opts,myData);
	};
})();
