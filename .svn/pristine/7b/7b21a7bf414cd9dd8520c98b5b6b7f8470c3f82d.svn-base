...
public class ShiroDbRealm extends AuthorizingRealm
{
			...
			throws AuthenticationException
	{
		...
		if (user != null)
		{
			...
			return new SimpleAuthenticationInfo(new ShiroUser(user.getId(), user.getLoginName(),
					user.getName(),user.getCpCodes(),
					user.getProgramTypeIds(), user.getMaterialTypeIds()), user.getPassword(),
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals)
	{
		...
		info.addStringPermissions(buttonService.findButtonCodesByUserId(user.getId()));
		return info;
	}
	...
	public static class ShiroUser implements Serializable
	{
		...
		public String cpCodes;

		public String programTypeIds;

		public String materialTypeIds;

		public ShiroUser(Long id, String loginName, String name, String cpCodes,
				String programTypeIds, String materialTypeIds)
		{
			this.id = id;
